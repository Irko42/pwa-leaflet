...
import {
  ...
  utils_default,
  view_default
} from "./chunk-A4A57DTQ.js";
import "./chunk-R5PXEFTA.js";
import {
  __objRest,
  __spreadProps,
  __spreadValues,
...
var View = (0, import_react6.forwardRef)((props, ref) => {
  ...
  if (f7 && !f7View.current && init) {
    ...
    f7View.current = f7.views.create(elRef.current, __spreadProps(__spreadValues({
      routerId,
      init: false
  ...
  const onMount = () => {
    f7ready(() => {
      if (f7View.current) {
        ...
        f7routers.views.push(routerData.current);
        routerData.current.instance = f7.views.create(elRef.current, __spreadProps(__spreadValues({
          routerId
        }, noUndefinedProps(props)), {
          browserHistoryInitialMatch,
          on: {
  ...
  return import_react6.default.createElement("div", _extends2({
    ...
    }, initialComponent ? import_react6.default.cloneElement(initialComponent, __spreadValues({}, pageProps)) : isAsync ? useAsyncComponent(PageComponent, pageProps) : import_react6.default.createElement(PageComponent, pageProps));
  }));
});
...
var routerOpenIn = (router, url, options) => {
  ...
  const params = __spreadValues({}, options);
...
var Input = (0, import_react56.forwardRef)((props, ref) => {
  ...
  const onMount = () => {
    f7ready(() => {
      ...
      if (type === "datepicker") {
        f7Calendar.current = f7.calendar.create(__spreadValues({
          inputEl: inputElRef.current,
          value,
          on: {
      ...
      if (type === "colorpicker") {
        f7ColorPicker.current = f7.colorPicker.create(__spreadValues({
          inputEl: inputElRef.current,
          value,
          on: {
...
var Link = (0, import_react59.forwardRef)((props, ref) => {
  ...
  if (href === false)
    hrefComputed = void 0;
  const attrs = __spreadValues(__spreadValues({
    href: hrefComputed,
    target,
    "data-tab": isStringProp(tabLink) && tabLink || void 0
  }, routerAttrs(props)), actionsAttrs(props));
...
var ListButton = (0, import_react60.forwardRef)((props, ref) => {
  ...
  const linkAttrs = __spreadValues(__spreadValues({
    href: typeof link === "boolean" && typeof href === "boolean" ? "#" : link || href,
    target,
    "data-tab": isStringProp(tabLink) && tabLink
  }, routerAttrs(props)), actionsAttrs(props));
  const linkClasses = classNames(__spreadValues(__spreadValues(__spreadValues({
    "list-button": true,
    "tab-link": tabLink || tabLink === "",
    "tab-link-active": tabLinkActive
  }, colorClasses(props)), routerClasses(props)), actionsClasses(props)));
...
// node_modules/skeleton-elements/react/index.js
init_define_process_env();
  ...
  if (!routerData.current && routerContext && routerContext.route && routerContext.route.route && routerContext.route.route.tab && routerContext.route.route.tab.id === id) {
    ...
    if (component || asyncComponent) {
      ...
      initialTabContent = {
        ...
        props: __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, parentProps || {}), tabRouteOptions && tabRouteOptions.props || {}), {
...
var TreeviewItem = (0, import_react122.forwardRef)((props, ref) => {
  ...
  if (link === false)
    href = void 0;
  const itemRootAttrs = __spreadValues(__spreadValues({
    href
  }, routerAttrs(props)), actionsAttrs(props));
