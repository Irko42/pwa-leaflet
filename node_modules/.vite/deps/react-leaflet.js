import {
  require_react_dom
} from "./chunk-VED37PCW.js";
import {
  require_react
} from "./chunk-TL3DNWEG.js";
import {
  require_leaflet_src
} from "./chunk-N4HK4QCQ.js";
import {
  __objRest,
  __restKey,
  __spreadProps,
...
var Circle = createPathComponent(function createCircle(_a, ctx) {
...
var CircleMarker = createPathComponent(function createCircleMarker(_a, ctx) {
  var _b = _a, { center, children: _c } = _b, options = __objRest(_b, ["center", "children"]);
...
var FeatureGroup = createPathComponent(function createFeatureGroup(_a, ctx) {
  var _b = _a, { children: _c } = _b, options = __objRest(_b, ["children"]);
...
var GeoJSON = createPathComponent(function createGeoJSON(_a, ctx) {
...
var ImageOverlay = createLayerComponent(function createImageOveraly(_a, ctx) {
  var _b = _a, { bounds, url } = _b, options = __objRest(_b, ["bounds", "url"]);
...
var LayerGroup = createLayerComponent(function createLayerGroup(_a, ctx) {
  var _b = _a, { children: _c } = _b, options = __objRest(_b, ["children"]);
...
var useLayersControlElement = createElementHook(function createLayersControl(_a, ctx) {
  var _b = _a, { children: _c } = _b, options = __objRest(_b, ["children"]);
...
function MapContainerComponent(_a, forwardedRef) {
  var _b = _a, { bounds, boundsOptions, center, children, className, id, placeholder, style, whenReady, zoom } = _b, options = __objRest(_b, ["bounds", "boundsOptions", "center", "children", "className", "id", "placeholder", "style", "whenReady", "zoom"]);
...
function omitPane(obj, pane) {
  const _a = obj, { [pane]: _p } = _a, others = __objRest(_a, [__restKey(pane)]);
  return others;
}
...
var Polygon = createPathComponent(function createPolygon(_a, ctx) {
  var _b = _a, { positions } = _b, options = __objRest(_b, ["positions"]);
...
var Rectangle = createPathComponent(function createRectangle(_a, ctx) {
  var _b = _a, { bounds } = _b, options = __objRest(_b, ["bounds"]);
...
var TileLayer = createTileLayerComponent(function createTileLayer(_a, context) {
...
var VideoOverlay = createLayerComponent(function createVideoOverlay(_a, ctx) {
  var _b = _a, { bounds, url } = _b, options = __objRest(_b, ["bounds", "url"]);
  var _a2;
  const overlay = new import_leaflet21.VideoOverlay(url, bounds, options);
  if (options.play === true) {
    (_a2 = overlay.getElement()) == null ? void 0 : _a2.play();
  }
  return createElementObject(overlay, extendContext(ctx, {
    overlayContainer: overlay
  }));
...
var WMSTileLayer = createTileLayerComponent(function createWMSTileLayer(_a, context) {
  var _b = _a, { params = {}, url } = _b, options = __objRest(_b, ["params", "url"]);
  const layer = new import_leaflet22.TileLayer.WMS(url, __spreadValues(__spreadValues({}, params), withPane(options, context)));
  return createElementObject(layer, context);
